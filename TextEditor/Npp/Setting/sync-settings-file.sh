...
# @Last Modified time: 2022-12-21 00:26:33
...
function backup() {
    ...
    if [[ -a '/c/Users/Oranger/AppData/Roaming/Typora/profile.data' ]]; then
        show_green 'Preferences.json Exists, Backup operation going on ...'
        cp /c/Users/Oranger/AppData/Roaming/Typora/profile.data ./
        if [[ $? == 0 ]]; then
...
function recovery() {
    ...
    cp ./profile.data /c/Users/Oranger/AppData/Roaming/Typora/profile.data
    if [[ $? == 0 ]]; then
